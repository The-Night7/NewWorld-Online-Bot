...
REGISTRY.register(
    MobDefinition(
        ...
        level_stats={
    3: MobStats(hp=25.0, mp=15.0, STR=10.0, AGI=12.0, INT=5.0, DEX=10.0, VIT=5.0, base_attack=0.0),
    10: MobStats(hp=60.0, mp=40.0, STR=30.0, AGI=22.0, INT=10.0, DEX=20.0, VIT=12.0, base_attack=0.0),
},
        variants={},
    )
)

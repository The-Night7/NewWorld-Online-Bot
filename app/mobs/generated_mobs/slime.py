...
REGISTRY.register(
    MobDefinition(
        ...
        level_stats={
    5: MobStats(hp=100.0, mp=20.0, STR=5.0, AGI=3.0, INT=4.0, DEX=2.0, VIT=25.0, base_attack=0.0),
    10: MobStats(hp=150.0, mp=45.0, STR=18.0, AGI=6.0, INT=10.0, DEX=5.0, VIT=45.0, base_attack=0.0),
},
        variants={},
    )
)
